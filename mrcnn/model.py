...
def rpn_graph(feature_map, anchors_per_location, anchor_stride):
    ...
    #rpn_probs = KL.Activation(KL.Lambda(lambda t: tf.nn.softmax(t)),
...
def fpn_classifier_graph(rois, feature_maps, image_meta,
    ...
    #mrcnn_probs = KL.TimeDistributed(KL.Activation(KL.Lambda(
    #                                 lambda t: tf.nn.softmax(t))), 
    #                                 name="mrcnn_class")(mrcnn_class_logits)
    ...
    def unmold_detections(self, detections, mrcnn_mask, original_image_shape,
        ...
        for i in range(N):
            ...
            full_mask = utils.unmold_mask(masks[i], boxes[i], 
                                original_image_shape, self.config.DETECTION_MASK_THRESHOLD)
